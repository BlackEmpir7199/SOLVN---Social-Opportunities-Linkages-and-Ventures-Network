            ...
            Padding(
              ...
              child: AuthUserStreamWidget(
                builder: (context) => FlutterFlowDropDown<String>(
                  ...
                  options: const ['Individual', 'Angel ', 'Venture Capitalist'],
                  onChanged: (val) =>
              ...
              child: Row(
                ...
                children: [
                  Expanded(
                    child: Padding(
                      padding:
                          const EdgeInsetsDirectional.fromSTEB(0.0, 12.0, 20.0, 12.0),
                      child: AuthUserStreamWidget(
                        builder: (context) => TextFormField(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => Text(
                                valueOrDefault<String>(
                                  currentUserDocument?.dob != null
                                      ? currentUserDocument?.dob?.toString()
