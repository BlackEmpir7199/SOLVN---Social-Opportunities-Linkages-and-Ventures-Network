...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF020202);
  late Color secondary = const Color(0xFF262529);
  late Color tertiary = const Color(0xFF54565D);
  late Color alternate = const Color(0xFF000000);
  late Color primaryText = const Color(0xFF101213);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF3F4F9);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF1F6F9);
  late Color secondary = const Color(0xFFE3E3E3);
  late Color tertiary = const Color(0xFFACACAC);
  late Color alternate = const Color(0xFF57636C);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF95A1AC);
  late Color primaryBackground = const Color(0xFF3D3D3D);
